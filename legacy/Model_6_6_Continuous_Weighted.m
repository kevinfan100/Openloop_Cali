% MIMO TRANSFER FUNCTION FITTING AND SAMPLED-DATA SYSTEM CONVERSION
%
% Purpose:
%   Fit 6×6 MIMO transfer function from frequency response data (P1~P6)
%   and perform sampled-data system conversion via Zero-Order Hold (ZOH)
%
% Mathematical Model:
%   H(s) = [A2 / (s² + A1·s + A2)] · B
...
% --- Sampled-Data System Conversion Parameters ---
...
%% SECTION 6: SAMPLED-DATA SYSTEM CONVERSION (Zero-Order Hold)
...
fprintf('\n=== Sampled-Data System Conversion (ZOH, T=%.0e s) ===\n', T_sample);
