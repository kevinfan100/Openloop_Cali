%% ========================================================================
%  NTU_tweezer One-Curve Fitting 配置
...
function config = NTU_config()
    %% 路徑設定
    config = struct();
    config.project_root = fileparts(mfilename('fullpath'));  % NTU_tweezer/
    ...
    config.data_files = {
        ...
        'NTU_single_10hz.dat',
        'NTU_single_50hz.dat',
        'NTU_single_100hz.dat',
        'NTU_single_200hz.dat',
        'NTU_single_300hz.dat',
        'NTU_single_400hz.dat',
        'NTU_single_500hz.dat',
        'NTU_single_600hz.dat',
        'NTU_single_700hz.dat',
        'NTU_single_800hz.dat',
        'NTU_single_900hz.dat',
        'NTU_single_1000hz.dat',
        'NTU_single_1200hz.dat',
        'NTU_single_1400hz.dat',
        'NTU_single_1600hz.dat',
        'NTU_single_1800hz.dat',
        'NTU_single_2000hz.dat'
    };
