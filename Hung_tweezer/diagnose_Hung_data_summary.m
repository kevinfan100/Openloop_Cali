%% ========================================================================
%  HUNG_TWEEZER DATA QUALITY DIAGNOSTIC - SUMMARY ONLY
...
fprintf('\n');
fprintf('========================================================================\n');
fprintf('  HUNG_TWEEZER QUICK DIAGNOSTIC (SUMMARY ONLY)\n');
fprintf('========================================================================\n\n');

%% Configuration
EXCLUDE_FREQUENCIES = [0.1, 900];  % 排除問題頻率
RELATIVE_THRESHOLD_PERCENT = 0.2;   % 相對門檻
OUTPUT_FOLDER = 'results/diagnostics';
...
summary_text = {
    '\bf\fontsize{13}Data Quality Summary'; '';
    ...
    sprintf('  %.1f Hz (insufficient data)', EXCLUDE_FREQUENCIES(1));
    sprintf('  %.0f Hz (unstable)', EXCLUDE_FREQUENCIES(2))
};
...
% Save CSV
csv_filename = fullfile(OUTPUT_FOLDER, 'Bode_Summary.csv');
