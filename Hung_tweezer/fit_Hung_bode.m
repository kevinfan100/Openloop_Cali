%% ========================================================================
%  Hung_tweezer Transfer Function Fitting with Bode Plot
...
%
% Input:
%   results/bode_data/Hung_bode_data_for_fitting.mat
%
% Output:
%   - Console: 擬合參數和品質指標
...
fprintf('\n');
fprintf('========================================================================\n');
fprintf('  Hung_tweezer Transfer Function Fitting\n');
fprintf('========================================================================\n\n');
...
% input_file = fullfile(project_root, 'results', 'bode_data', 'Hung_bode_data_for_fitting.mat');
% use_csv = false;
...
SAVE_FIGURE = false;         % Save to file
