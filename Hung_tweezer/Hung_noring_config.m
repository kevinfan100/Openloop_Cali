%% ========================================================================
%  Hung_tweezer (No Ring) One-Curve Fitting 配置
...
function config = Hung_noring_config()
    ...
    config.data_folder = fullfile(config.project_root, 'single_noring_raw_data');
    config.output_folder = fullfile(config.project_root, 'results_noring');
    config.functions_path = fullfile(config.project_root, '..', 'functions');

    % 數據檔案清單（19 個頻率點）
    config.data_files = {
        'Hung_single_noring_0.1hz.dat',
        'Hung_single_noring_1hz.dat',
        'Hung_single_noring_10hz.dat',
        'Hung_single_noring_50hz.dat',
        'Hung_single_noring_100hz.dat',
        'Hung_single_noring_200hz.dat',
        'Hung_single_noring_300hz.dat',
        'Hung_single_noring_400hz.dat',
        'Hung_single_noring_500hz.dat',
        'Hung_single_noring_600hz.dat',
        'Hung_single_noring_700hz.dat',
        'Hung_single_noring_800hz.dat',
        'Hung_single_noring_900hz.dat',
        'Hung_single_noring_1000hz.dat',
        'Hung_single_noring_1200hz.dat',
        'Hung_single_noring_1400hz.dat',
        'Hung_single_noring_1600hz.dat',
        'Hung_single_noring_1800hz.dat',
        'Hung_single_noring_2000hz.dat'
    };
