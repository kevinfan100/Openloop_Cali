function config = Hung_pair_test1_3_config()
%HUNG_PAIR_TEST1_3_CONFIG Hung pair test1 耦合通道配置 (DA ch2 → Vm ch3)
%
% 與 Hung_pair_test1_2 共用同一組 .dat 檔案
% analysis_channel = 3 (coupled channel)

    config = default_config();

    %% 實驗識別
    config.experiment_name = 'Hung_pair_test1_3';
    ...
    config.output_folder = fullfile(config.project_root, 'results', 'Hung_pair_test1_3');
